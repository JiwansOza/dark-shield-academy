...
import { Badge, Award, Clock, CheckCircle, FileCheck, BookOpen, Building } from "lucide-react";
    ...
    return (
      <div className="min-h-screen bg-cyber-black">
        ...
        <div className="container mx-auto px-4 py-20 text-center">
          <h1 className="text-3xl text-white">Certification not found</h1>
          <p className="text-gray-400 mt-4">The certification you're looking for doesn't seem to exist.</p>
  ...
  return (
    <div className="min-h-screen bg-cyber-black">
          ...
          <div className="flex flex-col lg:flex-row items-center">
            ...
            >
              <div className="flex items-center mb-4">
                <motion.div 
                  className="p-2 bg-cyber-blue/10 rounded-lg mr-4"
                ...
                <h1 className="text-4xl md:text-5xl font-bold text-white">{certification.name}</h1>
              </div>
              <p className="text-gray-400 text-xl mb-4">Issued by: <span className="text-cyber-blue">{certification.organization}</span></p>
              <p className="text-gray-300 mb-6">{certification.longDescription}</p>
      ...
      <section className="py-16 bg-cyber-black relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <h2 className="text-3xl font-bold text-white mb-8 text-center">Certification <span className="text-cyber-blue">Benefits</span></h2>
      ...
      <section className="py-16 bg-cyber-black-light relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h2 className="text-3xl font-bold text-white mb-8">Exam <span className="text-cyber-blue">Information</span></h2>
            ...
            <div>
              <h2 className="text-3xl font-bold text-white mb-8">Exam <span className="text-cyber-blue">Topics</span></h2>
      ...
      <section className="py-16 bg-cyber-black relative">
        <div className="absolute inset-0 bg-matrix-pattern opacity-5"></div>
        <div className="container mx-auto px-4 relative z-10">
          <h2 className="text-3xl font-bold text-white mb-8 text-center">Certification <span className="text-cyber-blue">Preparation</span></h2>
